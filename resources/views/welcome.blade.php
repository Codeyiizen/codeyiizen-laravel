...
<div class="onloadpage" id="page_loader">
    <div class="pre-content">
        <div class="logo-pre"><img src="{{ url('/') }}/public/assets/images/logo_white.png" alt="Logo"
                class="img-fluid" /></div>
            ...
            <div class="col-lg-5">
                <div class="hero-heading-sec">
                    ...
                    <div class="awards-block-tt  wow fadeIn" data-wow-delay="1s"><img
                            src="{{ url('/') }}/public/assets/images/awards-logo.png" alt="awards-logo"
                            class="img-fluid" /></div>
                </div>
            </div>
            <div class="col-lg-7">
                                    ...
                                    <div class="service-card-hh">
                                        <div class="image-sr-mm">
                                            <img alt="custom-sport"
                                                src="{{ url('/') }}/public/assets/images/service/vr.png">
                                        </div>
                            ...
                            <div class="service-slide card-bg-b" data-tilt data-tilt-max="10" data-tilt-speed="1000">
                                <a href="#">
                                    <div class="service-card-hh">
                                        <div class="image-sr-mm">
                                            <img alt="custom-sport"
                                                src="{{ url('/') }}/public/assets/images/service/startup.png">
                                        </div>
                            ...
                            <div class="service-slide card-bg-c" data-tilt data-tilt-max="10" data-tilt-speed="1000">
                                <a href="#">
                                    <div class="service-card-hh">
                                        <div class="image-sr-mm">
                                            <img alt="custom-sport"
                                                src="{{ url('/') }}/public/assets/images/service/app-develop.png">
                                        </div>
                            ...
                            <div class="service-slide card-bg-d" data-tilt data-tilt-max="10" data-tilt-speed="1000">
                                <a href="#">
                                    <div class="service-card-hh">
                                        <div class="image-sr-mm">
                                            <img alt="custom-sport"
                                                src="{{ url('/') }}/public/assets/images/service/car-rental.png">
                                        </div>
                            ...
                            <div class="service-slide card-bg-e" data-tilt data-tilt-max="10" data-tilt-speed="1000">
                                <a href="#">
                                    <div class="service-card-hh">
                                        <div class="image-sr-mm">
                                            <img alt="custom-sport"
                                                src="{{ url('/') }}/public/assets/images/service/ewallet.png">
                                        </div>
                            ...
                            <div class="service-slide card-bg-f" data-tilt data-tilt-max="10" data-tilt-speed="1000">
                                <a href="#">
                                    <div class="service-card-hh">
                                        <div class="image-sr-mm">
                                            <img alt="custom-sport"
                                                src="{{ url('/') }}/public/assets/images/service/marketing.png">
                                        </div>
        ...
        <div class="row justify-content-center text-center">
            <div class="col-lg-10">
                <div class="common-heading">
                    ...
                    <p><span class="text-radius text-light text-animation bg-b">Codeyiizen</span> is a reputable online
                        marketplace that specializes in <strong>Website Designing and Development</strong>, delivering
                        innovative solutions to enhance the visual appeal of websites. We have garnered awards for our
                        excellence in creating highly effective web solutions tailored to meet your specific business
                        needs.</p>

                    <h3 class="mt30 mb30">Convert your Ideas, into reality.</h3>
                    <p>
                        The expert professionals at Codeyiizen are dedicated to devising optimal strategies for your
                        business expansion, enabling you to outperform competitors on a global scale. Our skilled Web
                        designers leverage captivating graphics and designs, enhancing the clarity of your web interface
                        and layout through the use of different designing tools. Both website designing and development
                        are essential components for fostering growth in online businesses. Additionally, Codeyiizen
                        extends its services internationally, catering to clients in countries such as <strong>U.K, USA,
                            UAE,
                            Canada, Italy, Australia</strong>, among others.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row upset">
            <div data-tilt data-tilt-max="5" data-tilt-speed="1000" class="col-lg-6-cus wow fadeInUp"
                ...
                <div class="service-sec-brp srvc-bg-nx bg-gradient13 text-w">
                    ...
                    <p>Codeyiizen is a leading outsourcing company delivering Application Development Web Designing,
                        PHP,
    ...
    <div class="container">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="statistics">
                    <div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
                        <img src="{{ url('/') }}/public/assets/images/icons/startup.svg" alt="years"
                            class="img-fluid" />
                    </div>
                    <div class="statnumb">
                        <?php $dob='2015-05-27';
                        ...
                        ?>
                        <span class="counter"><?php echo $year; ?></span><span>+</span>
        ...
        <div class="row small t-ctr">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="statistics">
                    <div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
                        <img src="{{ url('/') }}/public/assets/images/icons/computers.svg" alt="project"
                            class="img-fluid" />
                    </div>
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="statistics mb0">
                    <div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
                        <img src="{{ url('/') }}/public/assets/images/icons/customer-service.svg" alt="support"
                            class="img-fluid" />
                    </div>
                    <div class="statnumb">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="common-heading text-l">
                    ...
                    <p>There are a lot of companies that do what we do. They share the same what and how, but our
                        clients
                    ...
                    <div class="itm-media-object mt40 tilt-3d">
                        <div class="media">
                            <div class="img-ab- base" data-tilt data-tilt-max="20" data-tilt-speed="1000"><img
                                    src="{{ url('/') }}/public/assets/images/icons/computers.svg" alt="icon"
                                    class="layer"></div>
                            <div class="media-body">
                                <h4>Strong management & Development work force</h4>
                                <p>Very strong management and development work force that is super energetic and keen in
                                    the
                        ...
                        <div class="media mt40">
                            <div class="img-ab- base" data-tilt data-tilt-max="20" data-tilt-speed="1000"><img
                                    src="{{ url('/') }}/public/assets/images/icons/worker.svg" alt="icon" class="layer">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media mt40">
                            <div class="img-ab- base" data-tilt data-tilt-max="20" data-tilt-speed="1000"> <img
                                    src="{{ url('/') }}/public/assets/images/icons/deal.svg" alt="icon" class="layer">
                            </div>
                            <div class="media-body">
                                ...
                                <p>With time and capital as a very valuable asset for every client today, we expertise
                                    solutions and timely projects and their future demands in accordance to their
                                    deadlines.
                                </p>
                            </div>
                        </div>
            ...
            <div class="col-lg-6">
                <div data-tilt data-tilt-max="5" data-tilt-speed="1000" class="single-image wow fadeIn"
                    data-wow-duration="2s"><img src="{{ url('/') }}/public/assets/images/about/about-company.jpg"
                        alt="image" class="img-fluid">
                </div>
                <p class="text-center mt30">We measure the requirement of the clients in one go, leaving little space
                    for
                    ambiguities, thus maximising result oriented tasks for product development and testing which
                    increase
                ...
                <div class="cta-card mt60 text-center">
                    ...
                    <a href="{{ route('contactus') }}" class="btn-outline lnk mt30">Request A Quote <i
...
<section class="portfolio-section bg-gradient6 py-5">
    ...
    <div class="swiper mySwiper">
        <div class="swiper-wrapper">
            <div class="swiper-slide"><img alt="" class="img-fluid"
                    src="{{ url('/') }}/public/assets/images/portfolio/portfolio1.png"></div>
            <div class="swiper-slide"><img alt="" class="img-fluid"
                    src="{{ url('/') }}/public/assets/images/portfolio/portfolio2.png"></div>
            <div class="swiper-slide"><img alt="" class="img-fluid"
                    src="{{ url('/') }}/public/assets/images/portfolio/portfolio3.png"></div>
            <div class="swiper-slide"><img alt="" class="img-fluid"
                    src="{{ url('/') }}/public/assets/images/portfolio/portfolio4.png"></div>
            <div class="swiper-slide"><img alt="" class="img-fluid"
                    src="{{ url('/') }}/public/assets/images/portfolio/portfolio5.png"></div>
            <div class="swiper-slide"><img alt="" class="img-fluid"
                    src="{{ url('/') }}/public/assets/images/portfolio/portfolio6.png"></div>
            <div class="swiper-slide"><img alt="" class="img-fluid"
                    src="{{ url('/') }}/public/assets/images/portfolio/portfolio7.png"></div>
            <div class="swiper-slide"><img alt="" class="img-fluid"
                    src="{{ url('/') }}/public/assets/images/portfolio/portfolio8.png"></div>
            <div class="swiper-slide"><img alt="" class="img-fluid"
                    src="{{ url('/') }}/public/assets/images/portfolio/portfolio9.png"></div>
        </div>
    ...
    <div class="row d-none">
        <div class="col-lg-8 col-sm-8 mt60 wow fadeInUp" data-wow-delay="0.2s">
            <div class="isotope_item hover-scale">
                <div class="item-image" data-tilt data-tilt-max="2" data-tilt-speed="1000">
                    <a href="#"><img src="{{ url('/') }}/public/assets/images/portfolio/tradecj.png"
                            alt="Trade Cluj - Online store" class="img-fluid" /> </a>
                </div>
                <div class="item-info">
        ...
        <div class="col-lg-4 col-sm-4 mt60 wow fadeInUp" data-wow-delay="0.4s">
            <div class="isotope_item hover-scale">
                <div class="item-image" data-tilt data-tilt-max="2" data-tilt-speed="1000">
                    <a href="#"><img src="{{ url('/') }}/public/assets/images/portfolio/lido-macaro.jpg"
                            alt="Lido Macaro" class="img-fluid" />
                    </a>
                </div>
                <div class="item-info">
        ...
        <div class="col-lg-4 col-sm-4 mt60 wow fadeInUp" data-wow-delay="0.6s">
            <div class="isotope_item hover-scale">
                <div class="item-image" data-tilt data-tilt-max="2" data-tilt-speed="1000">
                    <a href="#"><img src="{{ url('/') }}/public/assets/images/portfolio/yper.png" alt="Yper"
                            class="img-fluid" /> </a>
                </div>
                <div class="item-info">
                    <h4><a href="#">Creative App</a></h4>
                ...
                <div class="clients-logos text-center col-12">
                    <ul class="row text-center clearfix">
                        <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay=".2s">
                            <div class="brand-logo"><img src="{{ url('/') }}/public/assets/images/client/tradecj.png"
                                    alt="tradecj" class="img-fluid">
                            </div>
                            <p>Trade Cluj, Southeast Europe</p>
                        </li>
                        <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay=".4s">
                            <div class="brand-logo"><img
                                    src="{{ url('/') }}/public/assets/images/client/nutritionslimming.png"
                        ...
                        <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay=".6s">
                            <div class="brand-logo"><img src="{{ url('/') }}/public/assets/images/client/statuslabs.png"
                                    alt="statuslabs" class="img-fluid">
                            </div>
                            <p>Status Labs, USA</p>
                        </li>
                        <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay=".8s">
                            <div class="brand-logo"><img src="{{ url('/') }}/public/assets/images/client/macarro.png"
                                    alt="macarro" class="img-fluid">
                            </div>
                            <p>Lido Macarro, Europe</p>
                        </li>
                        <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="1s">
                            <div class="brand-logo"><img src="{{ url('/') }}/public/assets/images/client/iecc.png"
                                    alt="iecc" class="img-fluid">
                            </div>
                            <p>IECC, UK</p>
                        </li>
                        <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="1.2s">
                            <div class="brand-logo"><img src="{{ url('/') }}/public/assets/images/client/samsglobal.png"
                                    alt="samsglobal" class="img-fluid">
                            </div>
                            <p>Samsglobal, UK</p>
                        </li>
                        <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="1.4s">
                            <div class="brand-logo"><img
                                    src="{{ url('/') }}/public/assets/images/client/prabhatmediacreations.png"
                        ...
                        <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="1.6s">
                            <div class="brand-logo"><img
                                    src="{{ url('/') }}/public/assets/images/client/digiinteracts.png"
                                    alt="digiinteracts" class="img-fluid">
                            </div>
                            <p>Digi Interacts, India</p>
                        </li>
                        <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="1.8s">
                            <div class="brand-logo"><img src="{{ url('/') }}/public/assets/images/client/cas.png"
                                    alt="cas" class="img-fluid">
                            </div>
                            <p>CAS, UK</p>
                        </li>
                        <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="2s">
                            <div class="brand-logo"><img src="{{ url('/') }}/public/assets/images/client/souk.svg"
                                    alt="souk" class="img-fluid">
                            </div>
                            <p>Equipment Souk, UAE</p>
                        </li>
                        <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="2.2s">
                            <div class="brand-logo"><img src="{{ url('/') }}/public/assets/images/client/probot.png"
                                    alt="probot" class="img-fluid">
                            </div>
                        ...
                        <li class="col-lg-2 col-md-3 col-sm-4 col-6 wow fadeIn" data-wow-delay="2.4s">
                            <div class="brand-logo" data-tilt data-tilt-max="2" data-tilt-speed="1000"><img
                                    src="{{ url('/') }}/public/assets/images/client/radrap.png" alt="radrap"
                                    class="img-fluid">
                            </div>
                            <p>Radrap, Europe</p>
                        </li>
                ...
                <div class="work-card-set">
                    <div class="icon-set wow fadeIn" data-wow-delay=".2s">
                        <div class="work-card cd1">
                            <div class="icon-bg"><img src="{{ url('/') }}/public/assets/images/icons/icon-1.png"
                                    alt="Industries" /></div>
                    ...
                    <div class="icon-set wow fadeIn" data-wow-delay=".4s">
                        <div class="work-card cd2">
                            <div class="icon-bg"><img src="{{ url('/') }}/public/assets/images/icons/icon-2.png"
                                    alt="Industries" /></div>
                    ...
                    <div class="icon-set wow fadeIn" data-wow-delay=".6s">
                        <div class="work-card cd3">
                            <div class="icon-bg"><img src="{{ url('/') }}/public/assets/images/icons/icon-3.png"
                                    alt="Industries" /></div>
                    ...
                    <div class="icon-set wow fadeIn" data-wow-delay=".8s">
                        <div class="work-card cd4">
                            <div class="icon-bg"><img src="{{ url('/') }}/public/assets/images/icons/icon-4.png"
                                    alt="Industries" /></div>
                            <p>Video Service</p>
                        </div>
                    </div>
                    <div class="icon-set wow fadeIn" data-wow-delay="1s">
                        <div class="work-card cd5">
                            <div class="icon-bg"><img src="{{ url('/') }}/public/assets/images/icons/icon-5.png"
                                    alt="Industries" /></div>
                            <p>Banking Service</p>
                        </div>
                    </div>
                    <div class="icon-set wow fadeIn" data-wow-delay="1.2s">
                        <div class="work-card cd6">
                            <div class="icon-bg"><img src="{{ url('/') }}/public/assets/images/icons/icon-6.png"
                                    alt="Industries" /></div>
                    ...
                    <div class="icon-set wow fadeIn" data-wow-delay="1.4s">
                        <div class="work-card cd7">
                            <div class="icon-bg"><img src="{{ url('/') }}/public/assets/images/icons/icon-7.png"
                                    alt="Industries" /></div>
                    ...
                    <div class="icon-set wow fadeIn" data-wow-delay="1.6s">
                        <div class="work-card cd8">
                            <div class="icon-bg"><img src="{{ url('/') }}/public/assets/images/icons/icon-8.png"
                                    alt="Industries" /></div>
                    ...
                    <div class="icon-set wow fadeIn" data-wow-delay="1.8s">
                        <div class="work-card cd9">
                            <div class="icon-bg"><img src="{{ url('/') }}/public/assets/images/icons/icon-9.png"
                                    alt="Industries" /></div>
                            <p>Health Service</p>
                        </div>
                    </div>
                    <div class="icon-set wow fadeIn" data-wow-delay="2s">
                        <div class="work-card cd10">
                            <div class="icon-bg"><img src="{{ url('/') }}/public/assets/images/icons/icon-10.png"
                                    alt="Industries" /></div>
                            <p>Event & Ticket</p>
                        </div>
                    </div>
                    <div class="icon-set wow fadeIn" data-wow-delay="2.2s">
                        <div class="work-card cd11">
                            <div class="icon-bg"><img src="{{ url('/') }}/public/assets/images/icons/icon-11.png"
                                    alt="Industries" /></div>
                    ...
                    <div class="icon-set wow fadeIn" data-wow-delay="2.4s">
                        <div class="work-card cd12">
                            <div class="icon-bg"><img src="{{ url('/') }}/public/assets/images/icons/icon-12.png"
                                    alt="Industries" /></div>
                            ...
                            <div class="owl-item active" style="width: 278px; margin-right: 20px;">
                                <div class="video-review" data-tilt="" data-tilt-max="5" data-tilt-speed="1000">
                                    <a class="video-link" href="https://youtu.be/FCA6ZBuB_k4?autoplay=1&amp;rel=0">
                                        <img src="{{ url('/') }}/public/assets/images/client/client-pic.jpg"
                            ...
                            <div class="owl-item active" style="width: 278px; margin-right: 20px;">
                                <div class="video-review" data-tilt="" data-tilt-max="5" data-tilt-speed="1000">
                                    <a class="video-link" href="https://youtu.be/FCA6ZBuB_k4">
                                        <img src="{{ url('/') }}/public/assets/images/client/client-pic-a.jpg"
                                            alt="client" class="img-fluid">
                                        <div class="review-vid-details">
                                            <div class="-vid-ico"><span class="triangle-play"></span></div>
                                            <p>Jokvch Marlin</p>
                        ...
                        <div class="owl-stage"
                            ...
                            <div class="owl-item cloned" style="width: 551px;">
                                <div class="testimonial-card">
                                    <div class="t-text">
                                        <p>I am very pleased with your designing and development capability. Your team
                                            has
                                            excellent communication skills and a fast response and turnaround time.
                                            Highest work
                                            quality. I can say that Codeyiizen Software & Services Pvt Ltd. is an honest
                                            and
                                            decent group of people with the highest work ethic I have seen for
                                            development team.
                                        </p>
                                    </div>
                                    <div class="client-thumbs mt30">
                                        <div class="media v-center">
                                            <div class="user-image bdr-radius"><img
                                                    src="{{ url('/') }}/public/assets/images/user-thumb/lucian-rusorean.jpg"
                                                    alt="Iuliu Lucian Rusorean" class="img-fluid"></div>
                                            <div class="media-body user-info">
                                                <h5>Iuliu Lucian Rusorean</h5>
                                                <p>Founder, TradeCJ, <small>Romania, Southeast Europe</small></p>
                                                <div class="star-rate fa-sm">
                                                    <ul class="list-unstyled">
                                                        <li> <a href="javascript:void(0)" class="chked"><i
                                                                    class="fas fa-star" aria-hidden="true"></i></a>
                                                        </li>
                                                        <li> <a href="javascript:void(0)" class="chked"><i
                                                                    class="fas fa-star" aria-hidden="true"></i></a>
                                                        </li>
                            ...
                            <div class="owl-item cloned" style="width: 551px;">
                                <div class="testimonial-card">
                                    <div class="t-text">
                                        <p>A great development experience! The flexability and speed of response from
                                            the
                                            developer’s team, as well as the quality of the reports and reporting was
                                            exceptional.Happy to see again and again the commitment and dedication from
                                            your
                                    ...
                                    <div class="client-thumbs mt30">
                                        <div class="media v-center">
                                            <div class="user-image bdr-radius"><img
                                                    src="{{ url('/') }}/public/assets/images/user-thumb/francesco.jpg"
                                ...
                                <div class="testimonial-card">
                                    <div class="t-text">
                                        <p>Codeyiizen Software & Services Pvt Ltd. Lets you shine. It lets you put your
                                            thoughts together and gives the best IT services one can ever ask for. The
                                            entire
                                            team of Codeyiizen Software & Services Pvt Ltd. is energetic and they don’t
                                            treat
                                    ...
                                    <div class="client-thumbs mt30">
                                        <div class="media v-center">
                                            <div class="user-image bdr-radius"><img
                                                    src="{{ url('/') }}/public/assets/images/user-thumb/hadiur-rahman.jpg"
                                                    alt="Limon Hossain" class="img-fluid"></div>
                    ...
                    <div class="review-icons">
                        <a href="#" target="blank" class="wow fadeIn" data-wow-delay=".2s"
                            style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;"><img
                                src="{{ url('/') }}/public/assets/images/about/reviews-icon-1.png" alt="review"
                                class="img-fluid"></a>
                        <a href="#" target="blank" class="wow fadeIn" data-wow-delay=".4s"
                            style="visibility: visible; animation-delay: 0.4s; animation-name: fadeIn;"><img
                                src="{{ url('/') }}/public/assets/images/about/reviews-icon-2.png" alt="review"
                                class="img-fluid"></a>
                        <a href="#" target="blank" class="wow fadeIn" data-wow-delay=".6s"
                            style="visibility: visible; animation-delay: 0.6s; animation-name: fadeIn;"><img
                                src="{{ url('/') }}/public/assets/images/about/reviews-icon-3.png" alt="review"
                                class="img-fluid"></a>
                    </div>
                </div>
            </div>
