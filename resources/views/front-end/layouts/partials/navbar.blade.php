      ...
      <div class="container-fluid m-pad">
         <div class="menu-header">
            <div class="dsk-logo"><a class="nav-brand" href="{{ url('/') }}">
                  <img src="{{ url('/') }}/public/assets/images/logo_white.png" alt="Logo" class="mega-white-logo" />
                  <img src="{{ url('/') }}/public/assets/images/logo.png" alt="Logo" class="mega-darks-logo" />
               </a>
            </div>
            <div class="custom-nav" role="navigation">
               <ul class="nav-list">
                  ...
                  <li>
                     <a href="{{ route('portfolio') }}" class="menu-links">Portfolio</a>
                  </li>
                  <li class="sbmenu rpdropdown">
                     <a href="#" class="menu-links">Hire Us</a>
                     <div class="nx-dropdown menu-dorpdown">
                        <div class="sub-menu-section">
                           <div class="sub-menu-center-block">
                              <div class="sub-menu-column smfull">
                                 <ul>
                                    ...
                                    <li><a href="#">Hire Ionic Developer</a></li>
                                 </ul>
                              </div>
                           </div>
                        </div>
                  ...
                  <li class="contact-show">
                     ...
                     <div class="contact-inquiry">
                        <div class="contact-info-">
                           <div class="contct-heading">Codeyiizen Contacts</div>
                           <div class="inquiry-card-nn hrbg">
                              <div class="title-inq-c">FOR HR DEPARTMENT</div>
                              <ul>
                                 <li class="mb0"><img src="{{ url('/') }}/public/assets/images/flags/in.svg" alt="delhi office"
                                       class="flags-size">
                           ...
                           <div class="inquiry-card-nn">
                              ...
                              <ul>
                                 ...
                                 <li><i class="fas fa-envelope"></i><a
                                       href="mailto:business@codeyiizen.com">business@codeyiizen.com</a></li>
                              </ul>
                           </div>
                        </div>
                     </div>
                  </li>
                  <!--<li><a href="get-quote.html" class="btn-br bg-btn3 btshad-b2 lnk">Request A Quote<span-->
                  <!--         class="circle"></span></a></li>-->
               </ul>
            </div>
            <div class="mobile-menu2">
               <ul class="mob-nav2">
                  <li><a href="#" class="btn-round- btn-br bg-btn btshad-b1" data-toggle="modal"
         ...
         <nav id="main-nav">
            ...
            <ul class="bottom-nav">
               ...
               <li class="prb">
                  <a href="mailto:business@codeyiizen.com">
