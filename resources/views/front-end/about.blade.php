        ...
        <div class="row">
            <div class="col-lg-5 v-center">
                <div class="image-block upset bg-shape wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
                    <img src="{{ url('/') }}/public/assets/images/about/codeyiizen-ceo.jpg" alt="about us Codeyiizen"
                        class="img-fluid">
                </div>
            </div>
            <div class="col-lg-7">
                <div class="common-heading text-l">
                    ...
                    <p class="pt20"><i class="fas fa-quote-left mr-2"></i> In a crowded landscape, numerous companies
                        offer similar services to ours, focusing on the what and how. However, our clients choose us for
                        our unique why and who. Welcome to Codeyiizen - you've found your perfect match. <i
    ...
    <div class="container">
        ...
        <div class="row mt30">
            <div class="col-lg-6 col-sm-12 mt30">
                <div class="s-block2">
                    <div class="card-icon"><img src="{{ url('/') }}/public/assets/images/icons/vision.png" alt="icon"
                            class="w80 mb20">
                    </div>
                    <h3>Our Vision</h3>
                    <p class="mt15">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
            ...
            <div class="col-lg-6 col-sm-12 mt30">
                <div class="s-block2">
                    <div class="card-icon"><img src="{{ url('/') }}/public/assets/images/icons/mountain.png" alt="icon"
                            class="w80 mb20">
                    </div>
                    <h3>Our Mission</h3>
                    <p class="mt15">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
...
<section class="about-agencys pad-tb block-1">
    <div class="container">
        ...
        <div class="row justify-content-center niwaxgap40">
            <div class="col-lg-5 v-center order1">
                <div class="image-block">
                    <img src="{{ url('/') }}/public/assets/images/about/leadership.jpg" alt="about us Codeyiizen"
                        class="img-fluid">
                </div>
            </div>
        ...
        <div class="row justify-content-center niwaxgap40 mt60">
            ...
            <div class="col-lg-5 v-center order1">
                <div class="image-block">
                    <img src="{{ url('/') }}/public/assets/images/about/collaboration.jpg" alt="about us Codeyiizen"
                        class="img-fluid">
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-center niwaxgap40 mt60">
            ...
            <div class="col-lg-5 v-center order1">
                <div class="image-block">
                    <img src="{{ url('/') }}/public/assets/images/about/transparency.jpg" alt="about us Codeyiizen"
                        class="img-fluid">
                </div>
            </div>
        ...
        <div class="row upset">
            <div class="col-lg-3 col-sm-6 mt30">
                <div class="s-block up-hor">
                    <div class="s-card-icon"><img src="{{ url('/') }}/public/assets/images/icons/research.svg"
            ...
            <div class="col-lg-3 col-sm-6 mt30">
                <div class="s-block up-hor">
                    <div class="s-card-icon"><img src="{{ url('/') }}/public/assets/images/icons/monitor.svg"
                            alt="service" class="img-fluid">
                    </div>
            ...
            <div class="col-lg-3 col-sm-6 mt30">
                <div class="s-block up-hor">
                    <div class="s-card-icon"><img src="{{ url('/') }}/public/assets/images/icons/trasparency.svg"
                        ...
                        <div class="timeline-content">
                            ...
                            <div class="thumbs">
                                <img class="img-fluid rounded"
                                    src="{{ url('/') }}/public/assets/images/user-thumb/girl.jpg" alt="Codeyiizen">
                                <img class="img-fluid rounded"
                                    src="{{ url('/') }}/public/assets/images/user-thumb/girl2.jpg" alt="Codeyiizen">
                            </div>
                        </div>
                    </div>
                    <div class="timeline-row niwaxcnnt2">
                        ...
                        <div class="timeline-content">
                            ...
                            <div class="thumbs">
                                <img class="img-fluid rounded" src="{{ url('/') }}/public/assets/images/icons/badge.svg"
                                    alt="Codeyiizen">
                                <img class="img-fluid rounded" src="{{ url('/') }}/public/assets/images/icons/badge.svg"
                                    alt="Codeyiizen">
                            </div>
        ...
        <div class="single-slide owl-carousel mt60">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-4">
                    <div class="image-block upset">
                        <div class="image-div"><a href="#"><img
                                    src="{{ url('/') }}/public/assets/images/team/shiwjee.jpeg" alt="Shiwjee Pandey"
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-4">
                    <div class="image-block upset">
                        <div class="image-div"><a href="#"><img
                                    src="{{ url('/') }}/public/assets/images/team/anupam2.jpg" alt="Anupam Verma"
                                    class="img-fluid" /></a></div>
                    </div>
                </div>
                <div class="col-lg-5 col-md-5">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-4">
                    <div class="image-block upset">
                        <div class="image-div"><a href="#"><img
                                    src="{{ url('/') }}/public/assets/images/team/subhash.jpeg" alt="Subhash Prajapati"
                                    class="img-fluid" /></a></div>
                    </div>
                </div>
                <div class="col-lg-5 col-md-5">
                ...
                <div class="row">
                    <div class="col-lg-5 mt30 h-scl-">
                        <div class="img-ca2set h-scl-base"><img
                                src="{{ url('/') }}/public/assets/images/about/office-1.jpg" alt="companyname"
                                class="img-fluid w-100"></div>
                    </div>
                    <div class="col-lg-7 mt30 h-scl-">
                        <div class="img-ca2set h-scl-base"><img
                                src="{{ url('/') }}/public/assets/images/about/office-2.jpg" alt="companyname"
                                class="img-fluid w-100"></div>
                    </div>
                    <div class="col-lg-7 mt30 h-scl-">
                        <div class="img-ca2set h-scl-base"><img
                                src="{{ url('/') }}/public/assets/images/about/office-3.jpg" alt="companyname"
                                class="img-fluid w-100"></div>
                    </div>
                    <div class="col-lg-5 mt30 h-scl-">
                        <div class="img-ca2set h-scl-base"><img
                                src="{{ url('/') }}/public/assets/images/about/office-4.jpg" alt="companyname"
                                class="img-fluid w-100"></div>
                    </div>
                </div>
            </div>
